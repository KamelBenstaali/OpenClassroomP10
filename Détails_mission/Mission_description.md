...
1- Dans la première architecture, tu crées une API pour développer puis exposer ton système de recommandation. Pour faire le lien entre l’application et le système de recommandation, tu crées une Azure Functions

2- Dans la deuxième architecture, tu peux te passer de l’API, en exploitant les fonctionnalités **“Azure Blob storage input binding”** pour récupérer directement les fichiers et modèles, et en intégrant tes prédictions directement dans ton Azure Functions (je préfère cette option )
